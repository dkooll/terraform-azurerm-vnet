...
Using this approach we are able to specify multiple subnets on multiple vnets in the data structure. The usage examples below show which features can be enabled and applied.

The code base is validated using terratest and the example directory is used as the working directory. If needed it contains prerequirements and integrations to test the code.
